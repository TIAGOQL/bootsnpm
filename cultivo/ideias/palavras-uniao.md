# Palavras de união — inspiração

- **Estágio:** planta
- **Módulo REM:** palavra · M2 · M0
- **Plantada em:** 2026-08-04
- **Próximo passo:** releitura rápida quando a boca correr solta · voltar aos Sinais · marcar calma 1–5

## Nota

Inspiração nestas palavras — tudo aí:

| O quê | Forma |
| --- | --- |
| Nome da prática | [planta alma](planta-alma.md) |
...
| Reentrada | [novo começo](novo-comeco.md) |
| Horizonte | [nova era](nova-era.md) |
| Etapa | [nova fase](nova-fase.md) |

Base técnica: [peito + respiração](peito-e-respiracao-m2.md).

## Significação lógica (REM)

Não é só ritual. No stack REM:
...
4. **Palavras** — **é nois**, **Jesus mando**, **novo começo**, **nova era** e **nova fase** substituem reflexos de susto ou de “já era”. Mesma boca, outro vetor: afiliação / sentido / reentrada / horizonte / etapa.
...
**planta alma** = nome do hábito que segura 2–5 juntos.

## Por que importa

Um canteiro só. Gestos e palavras apontam pro mesmo lado — e o REM sabe medir.
