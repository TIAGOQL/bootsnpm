...
Revalida (Inep): teórica + prática; depois universidade pública revalida. Diploma precisa estar reconhecido no país de origem. “Válido via Revalida” ≠ automático.

## No REM

- [Análise](analise.html) — separar CONES, ANEAES, Revalida, nome-golpe
- [Sócrates](socrates.html) — não fingir que já sabe
- [Medo de seguir sonhos](medo-seguir-sonhos.html) — o passo
- [Higiene mental](higiene-mental.html) — limpar propaganda
- [O Engenheiro Arquiteto](o-engenheiro-arquiteto.html) — quem planta
- [M8](relaxamento-endocanabinoide.html#m8) — farmácia do SEC; esta página é escola, não fármaco

## Limite

Não é ranking, matrícula nem conselho. Checar CONES + ANEAES da sede, no ano em que estiver.
